...
import eirbudImage from '../assets/earbud.jpg';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src={eirbudImage} alt="Earbud" />
          ...
          <h1 className="text-lg text-gray-400 font-normal">Earphones</h1>
          <h1 className="text-xl text-black font-semibold">Smart Earbuds</h1>
          <h1 className="text-lg text-themepurple font-semibold">$45.98</h1>
